...
public class OrderDomainServiceImpl implements OrderDomainService {
  ...
  private void setOrderProductInformation(Order order, Restaurant restaurant) {
    order.getItems().forEach(orderItem -> restaurant.getProducts().stream()
        .filter(product -> product.equals(orderItem.getProduct()))
        .findFirst()
        .ifPresent(product -> orderItem.getProduct()
            .updateWithConfirmedNameAndPrice(product.getName(), product.getPrice())));
  }
}
